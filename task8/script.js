...
class Spreadsheet {
    ...
    handleKeyboardNavigation(e, isShift) {
        ...
        const mainGridContainer =
            this.container.querySelector(".main-grid-container");
        ...
        // Check if cell is off-screen to the bottom
            ...
            scrollY =
                cellY +
                cellHeight -
                (this.viewport.scrollTop + viewHeight);
        }
    ...
    showCellEditor(initialValue = null) {
        ...
        this.cellEditor.style.top = `${editorTop + rect.top}px`;
        this.cellEditor.style.left = `${editorLeft + rect.left}px`;
