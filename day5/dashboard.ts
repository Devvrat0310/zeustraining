...
import { navbarDropdownMenu } from "./components/hamburgerDropdown.ts";
import { courseCardsTemp } from "./components/courseCardItem.ts";
import { notificationWrapper } from "./components/notifications.ts";
import { announcementsWrapper } from "./components/announcements.ts";
